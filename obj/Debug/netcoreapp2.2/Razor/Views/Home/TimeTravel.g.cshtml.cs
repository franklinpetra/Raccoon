#pragma checksum "/Users/petrafranklin/Coding_DoJo/c_sharp/Assignments/RaccoonDachi/Views/Home/TimeTravel.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "747bf9628a88c3d070ea957e287657707b4d4d72"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"747bf9628a88c3d070ea957e287657707b4d4d72", @"/Views/Home/TimeTravel.cshtml")]
    ...
    public class Views_Home_TimeTravel : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "747bf9628a88c3d070ea957e287657707b4d4d723361", async() => {
            ...
            WriteLiteral("\n");
            EndContext();
            BeginContext(178, 12153, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "747bf9628a88c3d070ea957e287657707b4d4d724660", async() => {
                BeginContext(184, 12140, true);
                WriteLiteral(@"
    <p>Understanding time
...
Einstein's theory of special relativity says that time slows down or speeds up depending on how fast you move relative to something else. Approaching the speed of light, a person inside a spaceship would age much slower than his twin at h");
                WriteLiteral(@"ome. Also, under Einstein's theory of general relativity, gravity can bend time.
...
General relativity also provides scenarios that could allow travelers to");
                WriteLiteral(@" go back in time, according to NASA. The equations, however, might be difficult to physically achieve.
...
While Einstein's theories appear to make time travel difficult, some groups have propos");
                WriteLiteral(@"ed alternate solutions to jump back and forth in time.
...
An artist's impression of a black hole like the one weighed in this work, sitting in the core of a disk galaxy. The black-hole in NGC4526 weighs 450,000,000 times more than our own Sun. (Image credit: NASA/JP");
                WriteLiteral(@"L-Caltech)
Black holes
...
Another theory for potential time travelers involves something called cosmic strings — narrow tubes of energy stretched across");
                WriteLiteral(@" the entire length of the ever-expanding universe. These thin regions, left over from the early cosmos, are predicted to contain huge amounts of mass and therefore could warp the space-time around them.
...
The Doctor's time machine is the TARDIS, which stands for Time and Relative Dimensions in Space. (Image credit: BBCAmerica)
To accomplish this, ti");
                WriteLiteral(@"me machines often are thought to need an exotic form of matter with so-called ""negative energy density."" Such exotic matter has bizarre properties, including moving in the opposite direction of normal matter when pushed. Such matter could theoretically exist, but if it did, it might be present only in quantities too small for the construction of a time machine.

However, time-travel research suggests time machines are possible without exotic matter. The work begins with a doughnut-shaped hole enveloped within a sphere of normal matter. Inside this doughnut-shaped vacuum, space-time could get bent upon itself using focused gravitational fields to form a closed time-like curve. To go back in time, a traveler would race around inside the doughnut, going further back into the past with each lap. This theory has a number of obstacles, however. The gravitational fields required to make such a closed time-like curve would have to be very strong, and manipulating them would have to be very precise. [Related: Warp Spe");
                WriteLiteral(@"ed, Scotty? Star Trek's FTL Drive May Actually Work]
...
That ""simply, mathematically, doesn't work,"" he said i");
                WriteLiteral(@"n a past interview with sister site LiveScience.
...
Time travel by moving through higher dimensions: In ""Interstellar"" (2014), there are ""tesseracts"" available in which astronauts can travel because the vessel r");
                WriteLiteral(@"epresents time as a dimension of space. A similar concept is expressed in Madeleine L'Engle's ""A Wrinkle In Time"" (2018, based on the book series that started in 1963), where time is folded by means of a tesseract. The book, however, uses supernatural beings to make the travel possible.
...
Slow time travel: In ""Primer"" (2004), a traveler stays in a box while time traveling. For each minute ");
                WriteLiteral(@"they want to go back in time, they need to stay in the box for a minute. If they want to go back a day in time, they have to stay there for 24 hours.
...
Difficult methods to categorize: There's a rocket sled in ""Timecop"" (1994) that pops in and out of view when it's being used, which has led to much speculation about what's going on. There's also the Time Displacement Equipment in ""The Terminator"" movie series, which shows off how to fight a ");
                WriteLiteral(@"war in four dimensions (including time).
